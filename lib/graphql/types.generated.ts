...
export type CoreShopVariantAttributeIndex = {
  __typename?: 'CoreShopVariantAttributeIndex';
  attributes: Array<Maybe<CoreShopVariantAttributeIndexAttribute>>;
  productId: Scalars['Int']['output'];
  url: Scalars['String']['output'];
};

export type CoreShopVariantAttributeIndexAttribute = {
  __typename?: 'CoreShopVariantAttributeIndexAttribute';
...
export type Object_CoreShopProduct = Element & {
  ...
  variantAttributeIndex?: Maybe<Array<Maybe<CoreShopVariantAttributeIndex>>>;
  weight?: Maybe<Scalars['Float']['output']>;
